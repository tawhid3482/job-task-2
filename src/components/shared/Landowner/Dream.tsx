...
const Dream: React.FC = () => {
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* Background Image */}
      <img
        src="https://jcxbd.com/wp-content/uploads/2021/11/Page-Banners-Landowner-2.jpg"
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
        {/* Small Text */}
        <p className="text-sm tracking-widest font-light mb-5">
          START BUILDING YOUR
        </p>

        {/* Large Text */}
        <p className="text-lg md:text-8xl tracking-widest font-light mb-20">
          DREAM
        </p>
