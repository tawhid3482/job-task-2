...
const FixedSocialSidebar: React.FC = () => {
  return (
    ...
    <div className="fixed top-1/2 right-0 transform -translate-y-1/2 z-50 shadow-2xl hidden lg:block">
      ...
      {socialLinks.map((item, index) => {
        ...
        return (
          <motion.a
            ...
            className="w-16 h-16 bg-[#0047AB] border-b border-gray-700 flex items-center justify-center cursor-pointer transition-all duration-300"
      ...
      <div className="w-16 h-8 bg-[#0047AB] flex items-center justify-center">
