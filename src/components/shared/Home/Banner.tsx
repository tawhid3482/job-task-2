...
const bannerData: BannerSlide[] = [
  {
    url: "https://jcxbd.com/wp-content/uploads/2021/09/10-scaled-1.jpg",
    smallText: "ICONIC",
    largeText: "DESTINATION",
  },
  {
    url: "https://jcxbd.com/wp-content/uploads/2021/09/Website-4-1.jpg",
    smallText: "EMBAR",
    largeText: "ECOFRIENDLY",
  },
  {
    url: "https://jcxbd.com/wp-content/uploads/2021/09/09.jpg",
    smallText: "LOOK",
    largeText: "BEAUTIFUL",
  },
  {
    url: "https://jcxbd.com/wp-content/uploads/2021/09/10.jpg",
    smallText: "TECH",
    largeText: "INFORMATION",
  },
  {
    url: "https://jcxbd.com/wp-content/uploads/2021/11/Artboard-1100.jpg",
    smallText: "MODERN",
    largeText: "ARCHITECTURE",
  },
  {
    url: "https://jcxbd.com/wp-content/uploads/2021/09/15.jpg",
    smallText: "LUXURY",
    largeText: "ELEGANCE",
  },
];
...
const BannerText: React.FC<BannerTextProps> = ({ data, direction }) => {
...
const Banner: React.FC = () => {
  ...
  const data = bannerData[currentSlideIndex];
  ...
  const getSlideClasses = (index: number) => {
    ...
    if (direction === "next") {
      if (
        ...
        (currentSlideIndex === totalSlides - 1 && index === 0)
      )
    ...
    if (direction === "prev") {
      if (
        index < currentSlideIndex ||
        (currentSlideIndex === 0 && index === totalSlides - 1)
      )
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex items-end justify-between px-4 md:px-8 pb-1 md:pb-2">
        {/* Left Text */}
        <BannerText key={currentSlideIndex} data={data} direction={direction} />
